...
function Hero() {
  ...
  useEffect(() => {
    ...
    const seek = () => {
      if (seeking || video.seeking || video.readyState < 1 || !Number.isFinite(video.duration)) return;
  ...
  return (
    <section className="lp-video-hero" aria-label="LendSure lending intelligence">
      <div className="lp-video-backdrop" aria-hidden="true">
        <video
          ref={videoRef}
      ...
      <div className="lp-video-content">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
          <h1 className="lp-video-hero-title">
        ...
        <motion.p className="lp-video-hero-sub" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4, duration: 0.8 }}>
